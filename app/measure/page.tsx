    ...
    return (
      <div className="flex min-h-screen flex-col items-center justify-center gap-4 bg-[#0a0a0a] px-6 text-center">
        ...
        <p className="max-w-md text-sm text-zinc-500">
          Run the data API alongside this page:{' '}
          <code className="text-zinc-300">npm run dev:measure</code> (or{' '}
          <code className="text-zinc-300">npm run dev:api</code> on port 3131).
        </p>
        <button
          type="button"
